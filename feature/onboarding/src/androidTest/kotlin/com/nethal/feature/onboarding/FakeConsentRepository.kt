...
/**
 * Fake em memória de [ConsentRepository] para Compose UI Test — mesmo formato do
 * `FakeConsentRepository` já usado em `app/src/test` (`WelcomeViewModelTest`), recriado aqui
 * porque `:feature:*` nunca depende de código de teste do módulo `app`.
 */
