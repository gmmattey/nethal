 ...
 * desenhado via `Canvas` — mesmo path SVG `M15 6l-6 6 6 6` do `prototypes.dc.html`), usado em `2d`
 * — Onde encontrar a senha. Duplicado a partir de `:feature:pairing-discovery` em vez de
 * compartilhado (ADR 0002: um `:feature:*` nunca depende de outro `:feature:*`, cada módulo
 * mantém seus próprios átomos visuais).
 */
@Composable
